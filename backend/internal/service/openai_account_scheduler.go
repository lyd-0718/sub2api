...
func (s *defaultOpenAIAccountScheduler) selectBySessionHash(
	...
	if shouldClearStickySession(account, req.RequestedModel) || !openAIAccountPlatformMatches(ctx, account, req.Platform, req.RequestedModel) || !account.IsOpenAICompatible() || !account.IsSchedulable() {
		clearBinding()
		return nil, false, nil
	}
...
func (s *defaultOpenAIAccountScheduler) selectByLoadBalance(
	...
	for i := range accounts {
		...
		if !openAIAccountPlatformMatches(ctx, account, req.Platform, req.RequestedModel) || !account.IsOpenAICompatible() {
