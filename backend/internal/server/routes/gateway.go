...
import (
	...
	"github.com/Wei-Shaw/sub2api/internal/pkg/trace"
...
func RegisterGatewayRoutes(
	...
	isOpenAIResponsesCompatibleGatewayPlatform := func(c *gin.Context) bool {
		...
		case service.PlatformOpenAI, service.PlatformGrok,
			...
			service.PlatformMiniMax, service.PlatformOpenCodeGo, service.PlatformOpenRouter:
	...
	countTokensHandler := func(c *gin.Context) {
		switch getGroupPlatform(c) {
		case service.PlatformOpenAI, service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformMiniMax, service.PlatformOpenCodeGo, service.PlatformOpenRouter:
	...
	// 会话 trace 采集（二开）：必须在 apiKeyAuth 之后，fail-open，不影响转发。
	gateway.Use(trace.Middleware())
