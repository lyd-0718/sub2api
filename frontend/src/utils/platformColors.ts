...
const BADGE: Record<Platform, string> = {
  ...
  openrouter: 'bg-violet-500/10 text-violet-600 border-violet-500/30 dark:text-violet-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  openrouter: 'bg-violet-500/10 text-violet-600 dark:bg-violet-500/10 dark:text-violet-300',
...
const BORDER: Record<Platform, string> = {
  ...
  openrouter: 'border-violet-500/20 dark:border-violet-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  openrouter: 'border-violet-500/35 dark:border-violet-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  openrouter: 'bg-gradient-to-r from-violet-400 to-violet-500',
...
const TEXT: Record<Platform, string> = {
  ...
  openrouter: 'text-violet-600 dark:text-violet-400',
...
const ICON: Record<Platform, string> = {
  ...
  openrouter: 'text-violet-500 dark:text-violet-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  openrouter: 'bg-violet-500 text-white hover:bg-violet-600 active:bg-violet-700 dark:bg-violet-500/80 dark:hover:bg-violet-500',
...
const GRADIENT: Record<Platform, string> = {
  ...
  openrouter: 'from-violet-500 to-violet-600',
