<template>
  <AppLayout>
    ...
    <AccountActionMenu :show="menu.show" :account="menu.acc" :anchor-rect="menu.anchorRect" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" @openrouter-routing="handleOpenRouterRouting" />
    <OpenRouterRoutingModal :show="showOpenRouterRouting" :account="openRouterRoutingAcc" @close="closeOpenRouterRouting" @saved="reload" />
...
import OpenRouterRoutingModal from '@/components/account/OpenRouterRoutingModal.vue'
...
const showOpenRouterRouting = ref(false)
const openRouterRoutingAcc = ref<Account | null>(null)
...
const handleOpenRouterRouting = (a: Account) => { openRouterRoutingAcc.value = a; showOpenRouterRouting.value = true }
const closeOpenRouterRouting = () => { showOpenRouterRouting.value = false; openRouterRoutingAcc.value = null }
