export default {
    accounts: {
      ...
      concurrencyCapEffective: 'Effective concurrency cap {effective} (configured {configured})',
      concurrencyCapRestricted: 'Restricted',
      concurrencyCapPinned: 'Pinned',
      concurrencyCapFused: 'Fused (7d flaps {count}/{threshold})',
      concurrencyCapNextProbe: 'Next probe {time}',
