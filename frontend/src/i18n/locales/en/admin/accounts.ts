export default {
    accounts: {
      ...
      openrouterRouting: {
        menu: 'Provider routing',
        title: 'OpenRouter provider routing',
        description:
          'OpenRouter serves each model through many providers and balances by price by default, so consecutive requests can land on different providers and miss the prompt cache. Pick a primary and a backup provider per model: requests go to the primary first and switch to the backup only when the primary is unavailable.',
        enabled: 'Enable provider routing',
        enabledHint: 'When off, OpenRouter routes every model automatically',
        loading: 'Loading providers from OpenRouter…',
        loadFailed: 'Failed to load providers',
        noModels: 'This account has no model mapping yet. Add models in the account editor first.',
        model: 'Model',
        primary: 'Primary provider',
        backup: 'Backup provider',
        notSet: 'Not set (auto routing)',
        notMapped: 'No longer in the model mapping',
        providerError: 'Failed to load providers: {error}',
        fallbackNote: 'If both the primary and the backup are unavailable, OpenRouter routes to other providers automatically so requests do not fail.',
        cache: 'cache',
        uptime: 'uptime',
        unavailable: 'degraded',
        noTools: 'no tool calling',
        offline: 'no longer listed',
        saved: 'Provider routing saved',
      ...
      quotaControl: {
        ...
        tlsFingerprint: {
          ...
          hint: 'Use a fixed TLS fingerprint for this account\'s HTTPS HTTP/SSE requests',
