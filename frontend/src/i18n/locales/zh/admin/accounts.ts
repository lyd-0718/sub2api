export default {
    accounts: {
      ...
      openrouterRouting: {
        menu: '供应商路由',
        title: 'OpenRouter 供应商路由',
        description:
          '同一个模型在 OpenRouter 背后有很多家供应商，默认按价格自动分配，前后请求落到不同的家会用不上缓存。为模型指定首选和备选供应商后，请求会优先发往首选，首选不可用时转到备选。',
        enabled: '启用供应商路由',
        enabledHint: '关闭后所有模型都由 OpenRouter 自动路由',
        loading: '正在从 OpenRouter 获取供应商列表…',
        loadFailed: '获取供应商列表失败',
        noModels: '这个账号还没有模型映射，请先在编辑账号里添加模型',
        model: '模型',
        primary: '首选供应商',
        backup: '备选供应商',
        notSet: '不指定（自动路由）',
        notMapped: '已不在模型映射中',
        providerError: '供应商列表获取失败：{error}',
        fallbackNote: '首选和备选都不可用时，由 OpenRouter 自动路由到其他供应商，保证请求不失败。',
        cache: '缓存',
        uptime: '可用',
        unavailable: '异常',
        noTools: '不支持工具调用',
