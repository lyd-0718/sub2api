export default {
    accounts: {
      ...
      noProxy: '无代理',
      concurrency: '并发数',
      concurrencyCapEffective: '有效并发上限 {effective}（配置 {configured}）',
      concurrencyCapRestricted: '受限中',
      concurrencyCapPinned: '已人工锁定',
      concurrencyCapFused: '已熔断（7 天抖动 {count}/{threshold}）',
      concurrencyCapNextProbe: '下次探测 {time}',
      loadFactor: '负载因子',
